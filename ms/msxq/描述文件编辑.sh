...
#sileo 专属：作者名字
perl -p -i -e "s/bailu/gilshahar7/g" sileo副本.json

#支持系统
perl -p -i -e "s/---/12.0～13.6/g"  cydia副本 sileo副本.json
perl -p -i -e "s/1.0.0/1.0/g"  cydia副本 sileo副本.json
#更新时间
perl -p -i -e "s/2019-01-21/2020-05-31/g"  sileo副本.json
#perl -p -i -e "s/暂时没有历史版本/2019-05-04更新支持A12/g"  cydia副本
#截图
perl -p -i -e "s/yulanjietu.PNG/notesdate.jpeg/g"   sileo副本.json
