#!/bin/sh
perl -p -i -e "s/插件名字/Bongwater仿ios14通讯录/g"  cydia副本 sileo副本.json
perl -p -i -e "s/插件的描述文字/我也不知道这是啥/g"  cydia副本 sileo副本.json
#支持系统
...
mv cydia副本 bongwater
mv sileo副本.json bongwater.json
